      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
            Manage office staff, roles, and permissions.
          </p>
        </div>
        {user?.role === "Admin" && (
            ...
            <tbody className="divide-y divide-gray-100 dark:divide-gray-700">
              {usersList.map((u) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 text-sm text-gray-600 dark:text-gray-400">
                    {format(parseISO(u.createdAt), "MMM yyyy")}
                  </td>
                  <td className="px-6 py-4">
                    <span
                      className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium border ${u.status === "active" ? "bg-emerald-50 text-emerald-700 border-emerald-200 dark:bg-emerald-900/20 dark:text-emerald-400 dark:border-emerald-800" : "bg-red-50 text-red-700 border-red-200 dark:bg-red-900/20 dark:text-red-400 dark:border-red-800"}`}
                    >
