              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between py-3">
                  <div>
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400">
                      Get text messages for immediate meeting changes.
                    </p>
                  </div>
                  <button
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-medium text-gray-900 dark:text-white flex items-center gap-2">
                        MacBook Pro{" "}
                        <span className="text-[10px] font-bold px-2 py-0.5 bg-indigo-100 text-indigo-700 dark:bg-indigo-900 dark:text-indigo-300 rounded-full">
                          CURRENT
                        </span>
                      </p>
                      <p className="text-sm text-gray-500 dark:text-gray-400">
                        San Francisco, CA • Safari Browser
                      </p>
                    </div>
                  </div>
                </div>
                <div className="flex items-center justify-between py-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500 dark:text-gray-400">
                        San Francisco, CA • OfficeFlow iOS App
                      </p>
                    </div>
                  </div>
