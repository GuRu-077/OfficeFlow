...
import { DoorOpen, Plus, Edit2, Trash2, X } from "lucide-react";
...
export default function RoomsPage() {
      ...
      const newRoom = await db.createRoom({
        ...
        amenities: currentRoom.amenities
          ? typeof currentRoom.amenities === "string"
            ? currentRoom.amenities.split(",").map((s) => s.trim())
  ...
  if (loading)
    return (
      <div className="animate-pulse h-64 bg-gray-100 dark:bg-gray-800 rounded-2xl"></div>
    );
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
            Manage office conference rooms and workspaces.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {rooms.map((room) => (
          <div
            key={room.id}
            className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-6 shadow-sm relative group"
          >
            <div className="flex items-center gap-4 mb-4">
              <div
                className={`p-3 rounded-xl ${room.availability === "available" ? "bg-emerald-100 text-emerald-600 dark:bg-emerald-900/30 dark:text-emerald-400" : "bg-orange-100 text-orange-600 dark:bg-orange-900/30 dark:text-orange-400"}`}
              >
              ...
              <div>
                ...
                <span
                  className={`text-xs font-medium px-2 py-0.5 rounded-full ${room.availability === "available" ? "bg-emerald-50 text-emerald-700 dark:bg-emerald-900/20 dark:text-emerald-400 border border-emerald-200 dark:border-emerald-800" : "bg-orange-50 text-orange-700 dark:bg-orange-900/20 dark:text-orange-400 border border-orange-200 dark:border-orange-800"}`}
                >
            ...
            <form onSubmit={handleSaveRoom} className="p-6 space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-600 rounded-lg focus:ring-indigo-500 text-gray-900 dark:text-white"
                />
              </div>
              ...
              <div>
                ...
                <select
                  value={currentRoom.availability || "available"}
                  onChange={(e) =>
                    setCurrentRoom({
                      ...currentRoom,
